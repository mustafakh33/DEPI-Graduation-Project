...
export default function TestResult() {
  ...
  const getLevelColor = (level: string) => {
    switch (level.toLowerCase()) {
      case "beginner":
        return "from-emerald-500 to-teal-400 text-emerald-400 bg-emerald-500/10 border-emerald-500/20";
      case "intermediate":
        return "from-blue-500 to-cyan-400 text-blue-400 bg-blue-500/10 border-blue-500/20";
      case "advanced":
        return "from-purple-500 to-pink-400 text-purple-400 bg-purple-500/10 border-purple-500/20";
      default:
        return "from-gray-500 to-gray-400 text-gray-400 bg-gray-500/10 border-gray-500/20";
    }
  };
      ...
      <div className="w-full max-w-3xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div
              className={`w-20 h-20 rounded-2xl flex items-center justify-center mb-6 shadow-2xl ${levelStyle.split(" ")[2]} border border-white/10`}
            >
            ...
            <p className="text-gray-400 max-w-md mx-auto mt-4">
              Great job! Your current knowledge places you at the{" "}
              <strong className="text-white">{result.level}</strong> level.
              We've adjusted your path to skip the basics and focus on more
              advanced concepts.
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-sm text-gray-400 pt-4 border-t border-white/5">
              Your curriculum is now specialized for {selectedTrack.title} at
              the {result.level} tier.
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-sm text-gray-400 pt-4 border-t border-white/5">
              Based on {schedule.days.length} days of study, mostly in the{" "}
