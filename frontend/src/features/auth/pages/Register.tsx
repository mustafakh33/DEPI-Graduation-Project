  ...
  return (
    ...
    >
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="space-y-1.5">
          <label htmlFor="email" className="text-sm font-medium text-gray-400 ml-1">University Email</label>
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-gray-500 ml-1 mt-1">Min. 8 characters with numbers and symbols</p>
        </div>
