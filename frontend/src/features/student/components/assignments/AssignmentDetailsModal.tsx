                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-400">
                        Upload your PDF answer before the deadline, then submit
                        the assignment.
                      </p>
                    </div>
                  </div>
              ...
              {displayStatus === "missed" ? (
                <section className="rounded-2xl border border-red-500/40 bg-red-500/5 p-4">
                  ...
                  <p className="mt-2 text-xs leading-5 text-slate-400">
                    The deadline has passed. You can still view and download the
                    assignment file, but you cannot upload or submit an answer.
                  </p>
                </section>
              ) : null}
            </aside>
