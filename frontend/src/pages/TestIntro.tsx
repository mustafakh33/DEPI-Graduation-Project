...
import { Brain, Clock, ShieldAlert, Target, ArrowRight, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-3xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-black/40 border border-white/10 rounded-2xl p-6 text-center">
            ...
            <div className="text-xl font-bold text-white mb-1">20 Questions</div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 flex gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-100/70 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                <span>Don't use external resources. We want to know your true baseline.</span>
              </li>
            </ul>
          </div>
        </div>
