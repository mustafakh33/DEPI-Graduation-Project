...
import { BrainCircuit, Code2, ShieldCheck, Smartphone, Check, ArrowRight } from "lucide-react";
...
const tracks = [
  {
    ...
    description: "Build full-stack web applications from scratch using modern technologies.",
  ...
  },
  {
    ...
    description: "Master machine learning, data analysis, and AI model building.",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    title: "Cybersecurity",
    description: "Learn ethical hacking, network security, and prepare for industry certifications.",
...
export default function TrackSelection() {
  ...
  const [selectedTrack, setSelectedTrack] = useState<string | null>(storedTrack?.id ?? null);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto">
        {tracks.map((track, idx) => {
          ...
          return (
            ...
            >
              {isSelected && (
                <div className={`absolute inset-0 bg-gradient-to-br ${track.color} opacity-[0.03] pointer-events-none`} />
              )}
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-6">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors ${
                    ...
                    <Icon className={`w-6 h-6 ${isSelected ? track.textLight : 'text-gray-400 group-hover:text-gray-300'}`} />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className={`w-6 h-6 rounded-full border flex items-center justify-center transition-colors ${
                      isSelected ? 'border-transparent bg-white text-black' : 'border-gray-600'
                    }`}>
