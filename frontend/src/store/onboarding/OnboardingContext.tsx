...
import { placementQuestions, type PlacementQuestion } from "@/store/onboarding/questions";
...
function calculateLevel(score: number, total: number): TestResultState["level"] {
...
export function OnboardingProvider({ children }: { children: ReactNode }) {
  ...
  const submitPlacementTest = useCallback(() => {
    ...
    const result: TestResultState = {
      level: calculateLevel(score, state.testQuestions.length || placementQuestions.length),
      score,
